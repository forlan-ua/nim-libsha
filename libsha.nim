import libsha / [sha1, sha256, sha512, sha224, sha384, sha512m224, sha512m256]
export sha1, sha256, sha512, sha224, sha384, sha512m224, sha512m256
...
when isMainModule:
    ...
    let sha256Inst3 = newSha256()
    sha256Inst3.add(message[0 ..< 20])
    sha256Inst3.add(message[20 ..< message.len])
    assert(sha256Inst3.hexdigest().insertSep(' ', 8) == "D7A8FBB3 07D78094 69CA9ABC B0082E4F 8D5651E4 6D3CDB76 2D02D0BF 37C9E592")
